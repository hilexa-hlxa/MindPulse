...
(function (root) {
   ...
   *
   * The three real windows run 06:00 to midnight. The small hours are left
   * deliberately uncovered: nothing about 4am is morning, afternoon or
   * evening, so only anytime phrases are eligible then.
   */
  var WINDOWS = [
    {
      id: "anytime",
  ...
  function splitForNotification(phrase) {
    ...
    var note = phrase.note ? phrase.note.trim() : "";
    return {
